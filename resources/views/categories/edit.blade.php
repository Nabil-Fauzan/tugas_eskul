                ...
                <div class="p-8">
                    <form action="{{ route('categories.update', $category) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" placeholder="Masukkan nama kategori" class="w-full px-4 py-3 rounded-xl border @error('name') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @else border-gray-200 focus:border-indigo-500 focus:ring-indigo-200 @enderror focus:ring-4 transition duration-200" required autofocus>
                            @error('name')

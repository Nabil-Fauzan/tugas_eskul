                ...
                <div class="p-8">
                    @if ($categories->isEmpty())
                        <div class="text-center py-6">
                            <svg class="w-16 h-16 text-amber-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                            </svg>
                            <h3 class="text-lg font-medium text-gray-900 mb-1">Kategori belum tersedia</h3>
                            <p class="text-gray-500 mb-6">Anda harus membuat minimal satu kategori terlebih dahulu sebelum menambahkan barang.</p>
                    ...
                    @else
                        <form action="{{ route('products.store') }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Masukkan nama barang (cth: Asus ROG, T-Shirt Uniqlo)" class="w-full px-4 py-3 rounded-xl border @error('name') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @else border-gray-200 focus:border-indigo-500 focus:ring-indigo-200 @enderror focus:ring-4 transition duration-200" required autofocus>
                                @error('name')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-xl shadow-sm">
                                        ...
                                        <input type="number" name="price" id="price" min="0" step="any" value="{{ old('price') }}" placeholder="0" class="w-full pl-10 pr-4 py-3 rounded-xl border @error('price') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @else border-gray-200 focus:border-indigo-500 focus:ring-indigo-200 @enderror focus:ring-4 transition duration-200" required>
                                    </div>
                                    @error('price')
                                        <p class="mt-2 text-sm text-rose-600 flex items-center">
                                            <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="stock" id="stock" min="0" value="{{ old('stock', 0) }}" placeholder="0" class="w-full px-4 py-3 rounded-xl border @error('stock') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @else border-gray-200 focus:border-indigo-500 focus:ring-indigo-200 @enderror focus:ring-4 transition duration-200" required>
                                    @error('stock')
                                        <p class="mt-2 text-sm text-rose-600 flex items-center">
                                            <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
